...
export const singleton = (S: StructureBuilder, title: string, id: string): ListItemBuilder =>
...
export function count<T>(arr: Array<T>, singular: string = 'item', plural?: string) {
